...
def test_run():
    ...
    # .iloc used instead of .ix as it is deprecated
    print(df.loc["2019-06-01":"2019-06-30"])  # the month of June 2019

    # slice by column (symbols)
    print(df["GOOG"])  # a single labels selects a single column
    print(df[["IBM", "AAPL"]])  # a list of labels selects multiple columns

    # slice by row and column
    print(df.loc["2019-06-10":"2019-06-20", ["IBM", "AAPL"]])
